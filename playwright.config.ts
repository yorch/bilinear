  ...
  webServer: [
    {
      ...
      env: {
        JWT_SECRET: process.env.JWT_SECRET ?? 'e2e-test-jwt-secret-for-testing-purposes-only-32chars',
        JWT_REFRESH_SECRET: process.env.JWT_REFRESH_SECRET ?? 'e2e-test-refresh-secret-for-testing-purposes-only-xyz',
        NODE_ENV: 'test',
